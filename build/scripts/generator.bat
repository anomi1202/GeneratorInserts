...
set CLASSPATH=%APP_HOME%\lib\jcommander-1.72.jar;%APP_HOME%\lib\generator-0.1.0.jar;%APP_HOME%\lib\slf4j-api-1.7.25.jar;%APP_HOME%\lib\slf4j-log4j12-1.7.25.jar;%APP_HOME%\lib\log4j-1.2.17.jar

@rem Execute generator
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GENERATOR_OPTS%  -classpath "%CLASSPATH%" Main %CMD_LINE_ARGS%
